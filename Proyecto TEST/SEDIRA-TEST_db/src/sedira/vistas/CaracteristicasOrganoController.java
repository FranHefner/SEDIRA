...
/**
 * FXML Controller class Clase controladora de interfaz gráfica
 * CaracteristicasOrgano.fxml
 *
...
public class CaracteristicasOrganoController implements Initializable {
    ...
    public void btnEliminarItem() {
        ...
        Organo selectedOrgano = FuncionesGenerales.getOrganoActual();
        int selectedIndex = griValorDescripcion.getSelectionModel().getSelectedIndex();

        if (selectedItem != null) {
            String mensaje = griValorDescripcion.getSelectionModel().getSelectedItem().getDescripcion() + "  "
                    + griValorDescripcion.getSelectionModel().getSelectedItem().getValor() + "  "
                    + griValorDescripcion.getSelectionModel().getSelectedItem().getUnidad();
            ...
            if (result.get() == ButtonType.OK) {
                griValorDescripcion.getItems().remove(selectedIndex);
